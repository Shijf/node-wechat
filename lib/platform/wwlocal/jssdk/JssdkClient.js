 ...
 * @LastEditTime: 2020-06-24 23:04:18
 * @LastEditors: shijf
...
class JssdkClient {
    ...
    async configSignature(url = null, nonceStr = null, timestamp = null) {
        ...
        console.log(url, nonceStr, timestamp);
    ...
    async getJsTicket() {
        console.log('getJsTicket' , await this.ticket.getConfigTicket());

        return await this.ticket.getConfigTicket();
    }
    async getAgentConfigTicket() {
        console.log('getAgentConfigTicket' , await this.ticket.getAgentConfigTicket());
